...
#plot(221)#3 numbers:the total number of rows,columns and the number of subplot
plot(x_M1,y_M1,color='blue')
scatter(0,0,s=50,color='red')
scatter(xp1,yp1,s=10,color='black')
title('alpha=0.001',fontsize=16)
xlabel('x/AU')
xlim(-0.6,0.6)
ylabel('y/AU')
ylim(-0.6,0.6)
